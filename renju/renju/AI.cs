...
namespace renju
{
    class AI : AIInterface
    {
        ...
        static int[] minValue = new int[] { 1, 3, 7, 9, 13, 20, 13, 50, 100, 20, 150, 500, 10000 };
        static int[] maxValue = new int[] { 2, 4, 8, 10, 15, 25, 15, 60, 150, 25, 200, 600, 10000 };

        static int[] otherMinValue = new int[] { 0, 2, 4, 7, 10, 13, 10, 30, 70, 13, 70, 400, 8000 };
        static int[] otherMaxValue = new int[] { 0, 3, 5, 8, 12, 15, 12, 40, 120, 15, 120, 500, 8000 };
